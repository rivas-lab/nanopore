...
class Read:
    ...
    def __init__(self, aligned_segment, reference):
        ...
        self.__reference_start = aligned_segment.reference_start
        self.__reference_end = aligned_segment.reference_end
        ...
        # find all mismatches
        self.find_mismatches(aligned_segment, reference.get_seq(self.chr))
    ...
    def get_mismatches_polymorphic(self, snp_pos, quality_threshod=14):
        return [i for i in self.mismatches
                if i.reference_position in set(snp_pos) and
                i.quality >= quality_threshod and
                i.reference is not Nucleotide['N']]

    def get_mismatches_polymorphic_pos(self, snp_pos, quality_threshod=14):
        return np.array([x.reference_position for x
                         in self.get_mismatches_polymorphic(snp_pos, quality_threshod)])





    def ____get_mismatches_polymorphic(self, bim, quality_threshod=14,
    ...
    def ____get_mismatches_polymorphic_pos(self, bim, quality_threshod=14,
                                       pos_l=-1, pos_r=sys.maxint):
    ...
    def ____get_mismatches_and_find_bim_exact(self, bim, quality_threshod=14):
    ...
    def ____get_bim_interval(self, bim):
    ...
    def ____n_polymorphic_sites(self, bim):
    ...
    def ____non_polymorphic_error_rate(self, bim, quality_threshod=14):
